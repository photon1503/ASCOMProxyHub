...
//
// ASCOM Telescope driver for photonProxyHub
//
...
namespace ASCOM.photonProxyHub.Telescope
{
    ...
    //
    // Your driver's DeviceID is ASCOM.photonProxyHub.Telescope
    //
    // The COM Guid attribute sets the CLSID for ASCOM.photonProxyHub.Telescope
    // The COM ClassInterface/None attribute prevents an empty interface called _photonProxyHub from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("ba9e2e29-05d9-4c46-b27a-329d169b66a1")]
    [ProgId("ASCOM.photonProxyHub.Telescope")]
    [ServedClassName("ASCOM Telescope Driver for photonProxyHub")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Telescope : ReferenceCountedObjectBase, ITelescopeV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="photonProxyHub"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Telescope()
        {
            try
            {
                ...
                tl = new TraceLogger("", "photonProxyHub.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
